...
""" Pre-Training a 🤗 WavLM model on unlabeled audio data """
...
def main():
    ...
    sampling_rate = raw_datasets["train"]["audio"][0]["sampling_rate"]
    ...
    # 3. Load model
    config = WavLMConfig.from_pretrained(args.model_name_or_path)
    ...
    model = WavLMModel.from_pretrained(args.model_name_or_path)
